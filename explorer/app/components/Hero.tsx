...
const Hero = () => {
  ...
  const [searchResult, setSearchResult] = useState<{ objectId: string; name: string } | null>(null);
      ...
      <div className="relative z-10">
        ...
        >
          <div style={{ height: "56px" }} className="relative">
            ...
            {/* Dropdown panel */}
            {isDropdownOpen && (
              <div className="absolute left-0 right-0 z-40 mt-2 max-h-[600px] overflow-auto overscroll-contain rounded-2xl shadow-#1 max-sm:max-h-[360px] bg-modal backdrop-blur-xl dark:border dark:shadow-#2">
                {searchQuery.trim() === "" ? (
                  history.length > 0 && (
                        ...
                        {history.map((item) => (
                          ...
                          >
                            <div className="bg-subtle mr-1 rounded-full p-0.5">
                              <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-secondary">
                                <path d="M10.6257 3.19092H3.95898V18.6076H16.0423V8.60758M10.6257 3.19092L16.0423 8.60758M10.6257 3.19092V8.60758H16.0423M7.29232 11.9409H10.209M7.29232 15.2743H12.709" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"></path>
                              </svg>
                            </div>
                            <span className="inline-block max-w-[200px] truncate">{formatAddress(item)}</span>
                            <svg
                              width="20"
                              height="20"
                              viewBox="0 0 20 20"
                            ...
                            >
                              <path d="M5 15L15 5M5 5L15 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg>
                          </a>
                        ))}
                      </ul>
                  ...
                  <>
                    {searchResult && (
                      <div className="pb-2 text-left">
                        <div className="mt-3">
                          <p className="pl-[18px] text-xs text-secondary">Object</p>
                          <a
                            ...
                            <section className="flex items-center">
                              <div className="relative mr-3 h-8 w-8 shrink-0">
                                <div className="bg-subtle rounded-full mr-0 p-1.5">
                                  <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-secondary h-5 w-5">
                                    <path d="M10.0002 10.8994V17.9827M10.0002 10.8994L3.75 7.38378M10.0002 10.8994L16.0523 7.49503M10 3.16504L3.125 7.03223V14.7666L10 18.6338L16.875 14.7666V7.03223L10 3.16504Z" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"></path>
                                  </svg>
                                </div>
                              </div>
                              <div>
                                ...
                                <p className="line-clamp-1 break-all text-xs text-secondary">{searchResult.objectId}</p>
                              </div>
                            </section>
                            <svg width="36" height="24" viewBox="0 0 36 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="z-3 absolute right-4 h-6 w-8 max-md:hidden">
                              <rect width="36" height="24" rx="8" fill="white"></rect>
                              <path d="M15.3352 15.4986L12.3821 12.5455L15.3352 9.59233V15.4986ZM14.4304 13.0824V12.0085H23.3693V13.0824H14.4304ZM22.3253 13.0824V6.81818H23.3991V13.0824H22.3253Z" fill="#111827"></path>
                            </svg>
                          </a>
                        </div>
                      </div>
