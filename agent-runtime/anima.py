...
class AnimaCLI:
    ...
    def cmd_publish_skill(self, args) -> int:
        ...
        try:
            ...
            blob_id = self.walrus_publisher.publish_skill_config_from_file(config_file)
    ...
    def cmd_status(self, args) -> int:
        ...
        try:
            ...
            if config_file.exists():
                ...
                print(f"   ✓ Constraints: max_spend={config.get('execution_constraints', {}).get('max_spend_per_ptb_mist')} mist")
            else:
